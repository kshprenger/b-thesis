...
Можно видеть, что данный алгоритм не иммет принципиальных различий с классической неблокирующей синхронизацией. Добавляется дополнительный объект координирующий множественную транзацкию - mwcas.
