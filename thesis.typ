...
Для реализации алгоритма, основанного на использовании транзакционной памяти, выделим атомарные ячейки, участвующиев в транхзакциях. Используемый тип атомарных ячеек - u64, так как большинство архитектур имеет в качестве размера указателя машинное слово длиной 64 бит.
