...
При использовании неблокирующей синхронизации образуется общий подход при построении структуры даннных и операций над ней. В большинстве случаев необходима модификация структуры на основе её текущего состояния.
...
#HeaderNumbered("Принцип рыботы MWCAS", 2)
